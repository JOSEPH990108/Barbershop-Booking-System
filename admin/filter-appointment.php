...
<div class="main-content">
        <div class="wrapper">
        <h1>Appointments</h1>
        <form method="POST" action='http://localhost/barbershopbookingsystem/admin/filter-appointment.php'>
        <input type="date" name="sdate" required title="Please select a date">
        <input type="submit" name="search" value="Search">
        <input type="button" name=cancel value="Clear" onClick="document.location.href='http://localhost/barbershopbookingsystem/admin/manage-appointment.php';" >
        </form>
        <br/>
            <table class="tbl-full">
                ...
                <?php
                    ...
                    if(isset($_POST['search']))
                    {
                        ...
                        $total_pages_sql = "SELECT COUNT(*) FROM tbl_appointment WHERE date='$sdate'";
            ...
            <div class="pagination">
                <?php
                    ...
                    if($page>=2){   
                        echo "<a href='filter-appointment.php?page=".($page-1)."'>  Prev </a>";   
                    }       
                               
                    for ($i=1; $i<=$total_pages; $i++) {   
                      if ($i == $page) {   
                          $pagLink .= "<a class = 'active' href='filter-appointment.php?page="  
                                                            .$i."'>".$i." </a>";   
                      }               
                      else  {   
                          $pagLink .= "<a href='filter-appointment.php?page=".$i."'>   
                                                            ".$i." </a>";     
                      }   
                    };     
                    echo $pagLink;   
                    ...
                    if($page<$total_pages){   
                        echo "<a href='filter-appointment.php?page=".($page+1)."'>  Next </a>";   
                    }

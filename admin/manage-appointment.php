        ...
        <input type="submit" name="search" value="Search">
            ...
            <div class="pagination">
                <?php
                    ...
                    if($page>=2){   
                        echo "<a href='manage-appointment.php?page=".($page-1)."'>  Prev </a>";   
                    }       
                               
                    for ($i=1; $i<=$total_pages; $i++) {   
                      if ($i == $page) {   
                          $pagLink .= "<a class = 'active' href='manage-appointment.php?page="  
                                                            .$i."'>".$i." </a>";   
                      }               
                      else  {   
                          $pagLink .= "<a href='manage-appointment.php?page=".$i."'>   
                                                            ".$i." </a>";     
                      }   
                    };     
                    echo $pagLink;   
                    ...
                    if($page<$total_pages){   
                        echo "<a href='manage-appointment.php?page=".($page+1)."'>  Next </a>";   
                    }
